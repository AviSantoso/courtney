...
import (
	...
	"github.com/AviSantoso/courtney/tester/logger"
	"github.com/AviSantoso/courtney/tester/merge"
...
func (t *Tester) processDir(dir string) error {
	...
	if err != nil {
		// TODO: Remove when https://github.com/AviSantoso/courtney/issues/4 is fixed
		// notest
		if t.setup.Verbose {
